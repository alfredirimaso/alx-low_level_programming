 ...
 * @e_ident: A pointer to array contain ELF magic numbers.
 *
 ...
 * @e_ident: A pointer to array containing ELF magic numbers.
 *
 * Description: Magic numbers are separatedby spaces.
 */
void print_magic(unsigned char *e_ident)
{
	int index;
